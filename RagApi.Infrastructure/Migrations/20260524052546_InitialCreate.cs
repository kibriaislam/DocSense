/*
-- Generated migration SQL (idempotent):
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260524052546_InitialCreate') THEN
...
BEGIN
    ...
    VALUES ('20260524052546_InitialCreate', '8.0.11');
    END IF;
END $EF$;
